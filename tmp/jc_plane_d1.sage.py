...
# This file was *autogenerated* from the file jc_plane_d1.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4)# hunt-spec 2026-07-26 — plane-JC side quest, round 1 (degree-1 slices).
...
noncst = [J.monomial_coefficient(m) for m in mono if m != R(_sage_const_1 )]
...
eqs = [Q(str(e)) for e in noncst] + [Q(str(const)) * Q('z') - _sage_const_1 ]
I = Q.ideal(eqs)
dim = I.dimension()
...
vals = {'a0': _sage_const_1 , 'a1': _sage_const_0 , 'a2': _sage_const_3 , 'b0': _sage_const_0 , 'b1': _sage_const_2 , 'b2': _sage_const_0 }
I2 = I + Q.ideal([inj[k] - QQ(vv) for k, vv in vals.items()])
print(f"after pinning l2 = (1+3v)x + 2u y: dim = {I2.dimension()}")
if I2.dimension() >= _sage_const_0 :
    # find rational point in remaining m,n vars
    G = I2.groebner_basis()
    print("sample groebner (first 4):")
    for g in list(G)[:_sage_const_4 ]: print("  ", g)

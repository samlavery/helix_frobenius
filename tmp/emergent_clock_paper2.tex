...
$N^{1/2}$, the per-cell forcibly-closed one is cell-bounded, native cells $30/30$), feeding the axis-reality
...
the forcible per-cell closure (Lemma~\ref{lem:forcible}, native cells, $30/30$ at the float64 floor) bounds the
adapted warped primitive, supplying the warped-Abel continuation to the axis neighbourhood that the axis-reality
reflection (Lemma~\ref{lem:bankreflection}) consumes; the residual mode vanishes by the focal
...
and Dirichlet classes, the forcible closure of Lemma~\ref{lem:forcible} for the cuspidal fibers) --- which is

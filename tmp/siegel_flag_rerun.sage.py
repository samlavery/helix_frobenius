...
# This file was *autogenerated* from the file siegel_flag_rerun.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0p01 = RealNumber('0.01'); _sage_const_30p0 = RealNumber('30.0'); _sage_const_0 = Integer(0)# hunt-spec 2026-07-26 — flag ladder: re-run the 15 flagged characters with
...
for r in flags:
    ...
    zs = L.find_zeros(_sage_const_0p01 , _sage_const_30p0 , _sage_const_0p01 )
    nz2 = len([z for z in zs if _sage_const_0  < float(z) <= _sage_const_30p0 ])
    delta = nz2 - r["n_zeros"]
    verdict = "STABLE (anchor artifact)" if delta == _sage_const_0  else f"COUNT CHANGED +{delta} -> ESCALATE"

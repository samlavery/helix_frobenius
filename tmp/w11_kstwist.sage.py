...
# This file was *autogenerated* from the file w11_kstwist.sage
from sage.all_cmdline import *   # import sage library

_sage_const_6 = Integer(6); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_9 = Integer(9); _sage_const_60 = Integer(60); _sage_const_4 = Integer(4); _sage_const_8 = Integer(8)# W11: the KS-twist resolution.  Geometry demands: the eps-equivariant
...
for k in range(_sage_const_6 ):
    for base in [K6(_sage_const_1 ), CM[_sage_const_0 ]/CM[_sage_const_3 ], CM[_sage_const_3 ]/CM[_sage_const_0 ], CM[_sage_const_0 ]*CM[_sage_const_3 ],
                 _sage_const_1 /(CM[_sage_const_0 ]*CM[_sage_const_3 ]), CM[_sage_const_0 ]**_sage_const_2 , CM[_sage_const_3 ]**_sage_const_2 ]:
...
hits = []
for r in cands:
    rows = matrix(K6, _sage_const_9 , _sage_const_60 )
    ridx = _sage_const_0 
    for m in range(_sage_const_3 ):
        for n in range(_sage_const_3 , _sage_const_6 ):
            rows[ridx, POS[(_sage_const_4 +m, n)]] += _sage_const_1 
            rows[ridx, POS[(_sage_const_4 +n, m)]] += r
            ridx += _sage_const_1 
...
if len(hits) == _sage_const_1 :
    r = hits[_sage_const_0 ]
    ...
    T1 = matrix(K6, _sage_const_9 , _sage_const_60 )
    ridx = _sage_const_0 
    for m in range(_sage_const_3 ):
        for n in range(_sage_const_3 , _sage_const_6 ):
            T1[ridx, POS[(_sage_const_4 +m, n)]] += _sage_const_1 
            T1[ridx, POS[(_sage_const_4 +n, m)]] += -r
            ridx += _sage_const_1 
    P11 = matrix(K6, _sage_const_6 , _sage_const_60 )
    ridx = _sage_const_0 
    for m in range(_sage_const_3 ):
        for n in range(m, _sage_const_3 ):
            P11[ridx, POS[(_sage_const_4 +m, n)]] += _sage_const_1 
            P11[ridx, POS[(_sage_const_4 +n, m)]] += _sage_const_1 
            ridx += _sage_const_1 
    P22 = matrix(K6, _sage_const_6 , _sage_const_60 )
    ridx = _sage_const_0 
    for m in range(_sage_const_3 , _sage_const_6 ):
        for n in range(m, _sage_const_6 ):
            P22[ridx, POS[(_sage_const_4 +m, n)]] += _sage_const_1 
            P22[ridx, POS[(_sage_const_4 +n, m)]] += _sage_const_1 
            ridx += _sage_const_1 

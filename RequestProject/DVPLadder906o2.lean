import RequestProject.DVPLadder834o2
import RequestProject.DVPExhaustion906o2
import RequestProject.DVPStation419
import RequestProject.DVPStation1681o4
import RequestProject.DVPStation421
import RequestProject.DVPStation423
import RequestProject.DVPStation424
import RequestProject.DVPStation426
import RequestProject.DVPStation428
import RequestProject.DVPStation429
import RequestProject.DVPStation431
import RequestProject.DVPStation1727o4
import RequestProject.DVPStation433
import RequestProject.DVPStation435
import RequestProject.DVPStation437
import RequestProject.DVPStation438
import RequestProject.DVPStation439
import RequestProject.DVPStation441
import RequestProject.DVPStation442
import RequestProject.DVPStation444
import RequestProject.DVPStation445
import RequestProject.DVPStation1789o4
import RequestProject.DVPStation448
import RequestProject.DVPStation899o2
import RequestProject.DVPStation451
import RequestProject.DVPStation452

/-!
# Rung-453: on-line to 906/2, channel to 452.5
-/
...
/-- **The 238-station ladder is inhabited.** -/
theorem ladder906o2Data_holds : LadderData906o2 := by
  refine ⟨ladder906o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder906o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder906o2T]
  · intro i
    fin_cases i
    · norm_num [ladder906o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 906/2` is on the line.** -/
theorem online_below_906o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 906/2 → ρ.re = 1/2 :=
  online_below_906o2_of_ladder ladder906o2Data_holds

/-- **The channel to height 416.5, unconditional.** -/
theorem seat_channel_to_452_5 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 906/2) online_below_906o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder906o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_906o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_452_5
end AxiomAudit

import RequestProject.DVPLadder687o2
import RequestProject.DVPExhaustion743o2
import RequestProject.DVPStation345
import RequestProject.DVPStation347
import RequestProject.DVPStation348
import RequestProject.DVPStation350
import RequestProject.DVPStation351
import RequestProject.DVPStation353
import RequestProject.DVPStation355
import RequestProject.DVPStation713o2
import RequestProject.DVPStation715o2
import RequestProject.DVPStation359
import RequestProject.DVPStation361
import RequestProject.DVPStation362
import RequestProject.DVPStation364
import RequestProject.DVPStation365
import RequestProject.DVPStation367
import RequestProject.DVPStation737o2
import RequestProject.DVPStation739o2
import RequestProject.DVPStation371

/-!
# Rung-371.5: on-line to 743/2, channel to 371
-/
...
/-- The one hundred eighty-four station heights. -/
def ladder743o2T (i : Fin 184) : ℝ :=
  if i.val = 0 then 11
...
/-- **The 184-station ladder is inhabited.** -/
theorem ladder743o2Data_holds : LadderData743o2 := by
  refine ⟨ladder743o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder743o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder743o2T]
  · intro i
    fin_cases i
    · norm_num [ladder743o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 743/2` is on the line.** -/
theorem online_below_743o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 743/2 → ρ.re = 1/2 :=
  online_below_743o2_of_ladder ladder743o2Data_holds

/-- **The channel to height 371, unconditional.** -/
theorem seat_channel_to_371 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 743/2) online_below_743o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder743o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_743o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_371
end AxiomAudit

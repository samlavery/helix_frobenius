import RequestProject.DVPLadder1179o2
import RequestProject.DVPExhaustion1215o2
import RequestProject.DVPStation591
import RequestProject.DVPStation2369o4
import RequestProject.DVPStation2373o4
import RequestProject.DVPStation595
import RequestProject.DVPStation596
import RequestProject.DVPStation1195o2
import RequestProject.DVPStation599
import RequestProject.DVPStation1201o2
import RequestProject.DVPStation602
import RequestProject.DVPStation603
import RequestProject.DVPStation2417o4
import RequestProject.DVPStation1211o2
import RequestProject.DVPStation2429o4

/-!
# Rung-607.5: on-line to 1215/2, channel to 607
-/
...
/-- **The 347-station ladder is inhabited.** -/
theorem ladder1215o2Data_holds : LadderData1215o2 := by
  refine ⟨ladder1215o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder1215o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder1215o2T]
  · intro i
    fin_cases i
    · norm_num [ladder1215o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 1215/2` is on the line.** -/
theorem online_below_1215o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 1215/2 → ρ.re = 1/2 :=
  online_below_1215o2_of_ladder ladder1215o2Data_holds

/-- **The channel to height 416.5, unconditional.** -/
theorem seat_channel_to_607 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 1215/2) online_below_1215o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder1215o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_1215o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_607
end AxiomAudit

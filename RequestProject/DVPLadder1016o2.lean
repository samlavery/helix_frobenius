import RequestProject.DVPLadder995o2
import RequestProject.DVPExhaustion1016o2
import RequestProject.DVPStation499
import RequestProject.DVPStation501
import RequestProject.DVPStation1004o2
import RequestProject.DVPStation503
import RequestProject.DVPStation505
import RequestProject.DVPStation506
import RequestProject.DVPStation507

/-!
# Rung-508: on-line to 1016/2 = 508, channel to 507.5
-/
...
/-- **The 276-station ladder is inhabited.** -/
theorem ladder1016o2Data_holds : LadderData1016o2 := by
  refine ⟨ladder1016o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder1016o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder1016o2T]
  · intro i
    fin_cases i
    · norm_num [ladder1016o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 1016/2` is on the line.** -/
theorem online_below_1016o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 1016/2 → ρ.re = 1/2 :=
  online_below_1016o2_of_ladder ladder1016o2Data_holds

/-- **The channel to height 416.5, unconditional.** -/
theorem seat_channel_to_507_5 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 1016/2) online_below_1016o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder1016o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_1016o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_507_5
end AxiomAudit

import RequestProject.DVPLadder1215o2
import RequestProject.DVPExhaustion1269o2
import RequestProject.DVPStation2435o4
import RequestProject.DVPStation610
import RequestProject.DVPStation2445o4
import RequestProject.DVPStation2451o4
import RequestProject.DVPStation614
import RequestProject.DVPStation2461o4
import RequestProject.DVPStation617
import RequestProject.DVPStation1237o2
import RequestProject.DVPStation2479o4
import RequestProject.DVPStation621
import RequestProject.DVPStation622
import RequestProject.DVPStation1247o2
import RequestProject.DVPStation625
import RequestProject.DVPStation1253o2
import RequestProject.DVPStation2511o4
import RequestProject.DVPStation2517o4
import RequestProject.DVPStation5045o8
import RequestProject.DVPStation2527o4
import RequestProject.DVPStation633
import RequestProject.DVPStation2537o4

/-!
# Rung-634.5: on-line to 1269/2, channel to 634
-/
...
def ladder1269o2T (i : Fin 367) : ℝ :=
  ...
  else if i.val = 288 then 526
  else if i.val = 289 then 2113/4
  else if i.val = 290 then 529
  else if i.val = 291 then 1061/2
  else if i.val = 292 then 532
  else if i.val = 293 then 533
  else if i.val = 294 then 535
  else if i.val = 295 then 536
  else if i.val = 296 then 538
  else if i.val = 297 then 539
  else if i.val = 298 then 4323/8
  else if i.val = 299 then 541
  else if i.val = 300 then 543
  else if i.val = 301 then 545
  else if i.val = 302 then 546
  else if i.val = 303 then 1095/2
  else if i.val = 304 then 549
  else if i.val = 305 then 550
  else if i.val = 306 then 1103/2
  else if i.val = 307 then 553
  else if i.val = 308 then 555
  else if i.val = 309 then 556
  else if i.val = 310 then 2229/4
  else if i.val = 311 then 559
  else if i.val = 312 then 560
  else if i.val = 313 then 561
  else if i.val = 314 then 563
  else if i.val = 315 then 4515/8
  else if i.val = 316 then 566
  else if i.val = 317 then 567
  else if i.val = 318 then 568
  else if i.val = 319 then 1139/2
  else if i.val = 320 then 1141/2
  else if i.val = 321 then 573
  else if i.val = 322 then 574
  else if i.val = 323 then 1151/2
  else if i.val = 324 then 1153/2
  else if i.val = 325 then 578
  else if i.val = 326 then 1159/2
  else if i.val = 327 then 581
  else if i.val = 328 then 1165/2
  else if i.val = 329 then 584
  else if i.val = 330 then 585
  else if i.val = 331 then 1173/2
  else if i.val = 332 then 1175/2
  else if i.val = 333 then 589
  else if i.val = 334 then 591
  else if i.val = 335 then 2369/4
  else if i.val = 336 then 2373/4
  else if i.val = 337 then 595
  else if i.val = 338 then 596
  else if i.val = 339 then 1195/2
  else if i.val = 340 then 599
  else if i.val = 341 then 1201/2
  else if i.val = 342 then 602
  else if i.val = 343 then 603
  else if i.val = 344 then 2417/4
  else if i.val = 345 then 1211/2
  else if i.val = 346 then 2429/4
  else if i.val = 347 then 2435/4
  else if i.val = 348 then 610
  else if i.val = 349 then 2445/4
  else if i.val = 350 then 2451/4
  else if i.val = 351 then 614
  else if i.val = 352 then 2461/4
  else if i.val = 353 then 617
  else if i.val = 354 then 1237/2
  else if i.val = 355 then 2479/4
  else if i.val = 356 then 621
  else if i.val = 357 then 622
  else if i.val = 358 then 1247/2
  else if i.val = 359 then 625
  else if i.val = 360 then 1253/2
  else if i.val = 361 then 2511/4
  else if i.val = 362 then 2517/4
  else if i.val = 363 then 5045/8
  else if i.val = 364 then 2527/4
  else if i.val = 365 then 633
  else 2537/4

set_option maxRecDepth 16384 in
set_option maxHeartbeats 102400000 in
/-- **The 367-station ladder is inhabited.** -/
theorem ladder1269o2Data_holds : LadderData1269o2 := by
  refine ⟨ladder1269o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder1269o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder1269o2T]
  · intro i
    fin_cases i
    · norm_num [ladder1269o2T]
    ...
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_526_sign station_2113o4_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_2113o4_sign station_529_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_529_sign station_1061o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_1061o2_sign station_532_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_532_sign station_533_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_533_sign station_535_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_535_sign station_536_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_536_sign station_538_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_538_sign station_539_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_539_sign station_4323o8_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_4323o8_sign station_541_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_541_sign station_543_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_543_sign station_545_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_545_sign station_546_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_546_sign station_1095o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_1095o2_sign station_549_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_549_sign station_550_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_550_sign station_1103o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_1103o2_sign station_553_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_553_sign station_555_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_555_sign station_556_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_556_sign station_2229o4_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_2229o4_sign station_559_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_559_sign station_560_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_560_sign station_561_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_561_sign station_563_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_563_sign station_4515o8_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_4515o8_sign station_566_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_566_sign station_567_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_567_sign station_568_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_568_sign station_1139o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_1139o2_sign station_1141o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_1141o2_sign station_573_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_573_sign station_574_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_574_sign station_1151o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_1151o2_sign station_1153o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_1153o2_sign station_578_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_578_sign station_1159o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_1159o2_sign station_581_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_581_sign station_1165o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_1165o2_sign station_584_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_584_sign station_585_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_585_sign station_1173o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_1173o2_sign station_1175o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_1175o2_sign station_589_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_589_sign station_591_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_591_sign station_2369o4_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_2369o4_sign station_2373o4_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_2373o4_sign station_595_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_595_sign station_596_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_596_sign station_1195o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_1195o2_sign station_599_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_599_sign station_1201o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_1201o2_sign station_602_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_602_sign station_603_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_603_sign station_2417o4_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_2417o4_sign station_1211o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_1211o2_sign station_2429o4_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_2429o4_sign station_2435o4_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_2435o4_sign station_610_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_610_sign station_2445o4_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_2445o4_sign station_2451o4_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_2451o4_sign station_614_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_614_sign station_2461o4_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_2461o4_sign station_617_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_617_sign station_1237o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_1237o2_sign station_2479o4_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_2479o4_sign station_621_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_621_sign station_622_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_622_sign station_1247o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_1247o2_sign station_625_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_625_sign station_1253o2_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_1253o2_sign station_2511o4_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_2511o4_sign station_2517o4_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_2517o4_sign station_5045o8_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_5045o8_sign station_2527o4_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_neg_of_pos station_2527o4_sign station_633_sign
    · norm_num [ladder1269o2T]
      exact_mod_cast mul_neg_of_pos_of_neg station_633_sign station_2537o4_sign

/-- **Every nontrivial zero of ordinate `|γ| ≤ 1269/2` is on the line.** -/
theorem online_below_1269o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 1269/2 → ρ.re = 1/2 :=
  online_below_1269o2_of_ladder ladder1269o2Data_holds

/-- **The channel to height 416.5, unconditional.** -/
theorem seat_channel_to_634 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 1269/2) online_below_1269o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder1269o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_1269o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_634
end AxiomAudit

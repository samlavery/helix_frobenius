import RequestProject.DVPLadder671o2
import RequestProject.DVPExhaustion687o2
import RequestProject.DVPStation338
import RequestProject.DVPStation339
import RequestProject.DVPStation340
import RequestProject.DVPStation342
import RequestProject.DVPStation343

/-!
# Rung-343.5: on-line to 687/2, channel to 343
-/
...
/-- The one hundred sixty-six station heights. -/
def ladder687o2T (i : Fin 166) : ℝ :=
  if i.val = 0 then 11
...
/-- **The 166-station ladder is inhabited.** -/
theorem ladder687o2Data_holds : LadderData687o2 := by
  refine ⟨ladder687o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder687o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder687o2T]
  · intro i
    fin_cases i
    · norm_num [ladder687o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 687/2` is on the line.** -/
theorem online_below_687o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 687/2 → ρ.re = 1/2 :=
  online_below_687o2_of_ladder ladder687o2Data_holds

/-- **The channel to height 343, unconditional.** -/
theorem seat_channel_to_343 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 687/2) online_below_687o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder687o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_687o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_343
end AxiomAudit

import RequestProject.DVPLadder309o2
import RequestProject.DVPExhaustion399o2
import RequestProject.DVPStation157
import RequestProject.DVPStation158
import RequestProject.DVPStation160
import RequestProject.DVPStation162
import RequestProject.DVPStation164
import RequestProject.DVPStation166
import RequestProject.DVPStation168
import RequestProject.DVPStation339o2
import RequestProject.DVPStation172
import RequestProject.DVPStation174
import RequestProject.DVPStation176
import RequestProject.DVPStation177
import RequestProject.DVPStation179
import RequestProject.DVPStation181
import RequestProject.DVPStation183
import RequestProject.DVPStation741o4
import RequestProject.DVPStation186
import RequestProject.DVPStation188
import RequestProject.DVPStation191
import RequestProject.DVPStation385o2
import RequestProject.DVPStation194
import RequestProject.DVPStation196
import RequestProject.DVPStation395o2
import RequestProject.DVPStation199

/-!
# Rung-199.5: on-line to 399/2, channel to 199
-/
...
/-- The eighty station heights (seven half-integer, one quarter-integer). -/
def ladder399o2T (i : Fin 80) : ℝ :=
  if i.val = 0 then 11
...
/-- **The 80-station ladder is inhabited.** -/
theorem ladder399o2Data_holds : LadderData399o2 := by
  refine ⟨ladder399o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder399o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder399o2T]
  · intro i
    fin_cases i
    · norm_num [ladder399o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 399/2` is on the line.** -/
theorem online_below_399o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 399/2 → ρ.re = 1/2 :=
  online_below_399o2_of_ladder ladder399o2Data_holds

/-- **The channel to height 199, unconditional.** -/
theorem seat_channel_to_199 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 399/2) online_below_399o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder399o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_399o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_199
end AxiomAudit

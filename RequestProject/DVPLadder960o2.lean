import RequestProject.DVPLadder906o2
import RequestProject.DVPExhaustion960o2
import RequestProject.DVPStation909o2
import RequestProject.DVPStation456
import RequestProject.DVPStation457
import RequestProject.DVPStation459
import RequestProject.DVPStation1839o4
import RequestProject.DVPStation461
import RequestProject.DVPStation463
import RequestProject.DVPStation465
import RequestProject.DVPStation466
import RequestProject.DVPStation467
import RequestProject.DVPStation469
import RequestProject.DVPStation470
import RequestProject.DVPStation472
import RequestProject.DVPStation473
import RequestProject.DVPStation475
import RequestProject.DVPStation476
import RequestProject.DVPStation477
import RequestProject.DVPStation957o2
import RequestProject.DVPStation480

/-!
# Rung-480: on-line to 960/2, channel to 479.5
-/
...
/-- **The 257-station ladder is inhabited.** -/
theorem ladder960o2Data_holds : LadderData960o2 := by
  refine ⟨ladder960o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder960o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder960o2T]
  · intro i
    fin_cases i
    · norm_num [ladder960o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 960/2` is on the line.** -/
theorem online_below_960o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 960/2 → ρ.re = 1/2 :=
  online_below_960o2_of_ladder ladder960o2Data_holds

/-- **The channel to height 416.5, unconditional.** -/
theorem seat_channel_to_479_5 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 960/2) online_below_960o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder960o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_960o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_479_5
end AxiomAudit

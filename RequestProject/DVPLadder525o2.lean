import RequestProject.DVPLadder471o2
import RequestProject.DVPExhaustion525o2
import RequestProject.DVPStation237
import RequestProject.DVPStation239
import RequestProject.DVPStation240
import RequestProject.DVPStation242
import RequestProject.DVPStation243
import RequestProject.DVPStation246
import RequestProject.DVPStation495o2
import RequestProject.DVPStation249
import RequestProject.DVPStation250
import RequestProject.DVPStation252
import RequestProject.DVPStation254
import RequestProject.DVPStation256
import RequestProject.DVPStation257
import RequestProject.DVPStation259
import RequestProject.DVPStation521o2
import RequestProject.DVPStation262

/-!
# Rung-262.5: on-line to 525/2, channel to 262
-/
...
/-- The one hundred sixteen station heights. -/
def ladder525o2T (i : Fin 116) : ℝ :=
  if i.val = 0 then 11
...
/-- **The 116-station ladder is inhabited.** -/
theorem ladder525o2Data_holds : LadderData525o2 := by
  refine ⟨ladder525o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder525o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder525o2T]
  · intro i
    fin_cases i
    · norm_num [ladder525o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 525/2` is on the line.** -/
theorem online_below_525o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 525/2 → ρ.re = 1/2 :=
  online_below_525o2_of_ladder ladder525o2Data_holds

/-- **The channel to height 262, unconditional.** -/
theorem seat_channel_to_262 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 525/2) online_below_525o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder525o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_525o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_262
end AxiomAudit

import RequestProject.DVPLadder1142o2
import RequestProject.DVPExhaustion1179o2
import RequestProject.DVPStation573
import RequestProject.DVPStation574
import RequestProject.DVPStation1151o2
import RequestProject.DVPStation1153o2
import RequestProject.DVPStation578
import RequestProject.DVPStation1159o2
import RequestProject.DVPStation581
import RequestProject.DVPStation1165o2
import RequestProject.DVPStation584
import RequestProject.DVPStation585
import RequestProject.DVPStation1173o2
import RequestProject.DVPStation1175o2
import RequestProject.DVPStation589

/-!
# Rung-589.5: on-line to 1179/2, channel to 589
-/
...
/-- **The 334-station ladder is inhabited.** -/
theorem ladder1179o2Data_holds : LadderData1179o2 := by
  refine ⟨ladder1179o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder1179o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder1179o2T]
  · intro i
    fin_cases i
    · norm_num [ladder1179o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 1179/2` is on the line.** -/
theorem online_below_1179o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 1179/2 → ρ.re = 1/2 :=
  online_below_1179o2_of_ladder ladder1179o2Data_holds

/-- **The channel to height 416.5, unconditional.** -/
theorem seat_channel_to_589 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 1179/2) online_below_1179o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder1179o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_1179o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_589
end AxiomAudit

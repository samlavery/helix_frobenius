import RequestProject.DVPLadder525o2
import RequestProject.DVPExhaustion561o2
import RequestProject.DVPStation264
import RequestProject.DVPStation266
import RequestProject.DVPStation267
import RequestProject.DVPStation269
import RequestProject.DVPStation271
import RequestProject.DVPStation272
import RequestProject.DVPStation274
import RequestProject.DVPStation276
import RequestProject.DVPStation277
import RequestProject.DVPStation279
import RequestProject.DVPStation280

/-!
# Rung-280.5: on-line to 561/2, channel to 280
-/
...
/-- The one hundred twenty-seven station heights. -/
def ladder561o2T (i : Fin 127) : ℝ :=
  if i.val = 0 then 11
...
/-- **The 127-station ladder is inhabited.** -/
theorem ladder561o2Data_holds : LadderData561o2 := by
  refine ⟨ladder561o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder561o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder561o2T]
  · intro i
    fin_cases i
    · norm_num [ladder561o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 561/2` is on the line.** -/
theorem online_below_561o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 561/2 → ρ.re = 1/2 :=
  online_below_561o2_of_ladder ladder561o2Data_holds

/-- **The channel to height 280, unconditional.** -/
theorem seat_channel_to_280 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 561/2) online_below_561o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder561o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_561o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_280
end AxiomAudit

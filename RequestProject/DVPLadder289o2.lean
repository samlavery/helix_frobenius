...
import RequestProject.DVPExhaustion289o2
import RequestProject.DVPStation128
import RequestProject.DVPStation130
import RequestProject.DVPStation132
import RequestProject.DVPStation134
import RequestProject.DVPStation136
import RequestProject.DVPStation139
import RequestProject.DVPStation281o2
import RequestProject.DVPStation142
import RequestProject.DVPStation144

/-!
# Rung-144.5: on-line to 289/2, channel to 144
-/
...
/-- The fifty-one station heights (three half-integer: 111.5, 123.5, 140.5). -/
def ladder289o2T (i : Fin 51) : ℝ :=
  if i.val = 0 then 11
...
/-- **The 51-station ladder is inhabited.** -/
theorem ladder289o2Data_holds : LadderData289o2 := by
  refine ⟨ladder289o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder289o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder289o2T]
  · intro i
    fin_cases i
    · norm_num [ladder289o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 289/2` is on the line.** -/
theorem online_below_289o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 289/2 → ρ.re = 1/2 :=
  online_below_289o2_of_ladder ladder289o2Data_holds

/-- **The channel to height 144, unconditional.** -/
theorem seat_channel_to_144 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 289/2) online_below_289o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder289o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_289o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_144
end AxiomAudit

import RequestProject.DVPLadder960o2
import RequestProject.DVPExhaustion995o2
import RequestProject.DVPStation482
import RequestProject.DVPStation1933o4
import RequestProject.DVPStation485
import RequestProject.DVPStation486
import RequestProject.DVPStation487
import RequestProject.DVPStation489
import RequestProject.DVPStation491
import RequestProject.DVPStation492
import RequestProject.DVPStation1975o4
import RequestProject.DVPStation495
import RequestProject.DVPStation496
import RequestProject.DVPStation497

/-!
# Rung-497.5: on-line to 995/2, channel to 497
-/
...
/-- **The 269-station ladder is inhabited.** -/
theorem ladder995o2Data_holds : LadderData995o2 := by
  refine ⟨ladder995o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder995o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder995o2T]
  · intro i
    fin_cases i
    · norm_num [ladder995o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 995/2` is on the line.** -/
theorem online_below_995o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 995/2 → ρ.re = 1/2 :=
  online_below_995o2_of_ladder ladder995o2Data_holds

/-- **The channel to height 416.5, unconditional.** -/
theorem seat_channel_to_497 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 995/2) online_below_995o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder995o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_995o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_497
end AxiomAudit

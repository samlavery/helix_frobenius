import RequestProject.DVPLadder780o2
import RequestProject.DVPExhaustion813o2
import RequestProject.DVPStation392
import RequestProject.DVPStation393
import RequestProject.DVPStation394
import RequestProject.DVPStation396
import RequestProject.DVPStation397
import RequestProject.DVPStation399
import RequestProject.DVPStation401
import RequestProject.DVPStation402
import RequestProject.DVPStation404
import RequestProject.DVPStation405
import RequestProject.DVPStation406

/-!
# Rung-406.5: on-line to 813/2, channel to 406
-/
...
/-- **The 207-station ladder is inhabited.** -/
theorem ladder813o2Data_holds : LadderData813o2 := by
  refine ⟨ladder813o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder813o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder813o2T]
  · intro i
    fin_cases i
    · norm_num [ladder813o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 813/2` is on the line.** -/
theorem online_below_813o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 813/2 → ρ.re = 1/2 :=
  online_below_813o2_of_ladder ladder813o2Data_holds

/-- **The channel to height 406, unconditional.** -/
theorem seat_channel_to_406 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 813/2) online_below_813o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder813o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_813o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_406
end AxiomAudit

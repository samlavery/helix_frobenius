...
/-!
# Audit of the inverse-warp continuation step
...
`s = 1/2`.  Thus an inverse-warp theorem needs a quantitative hypothesis on the full inverse-warp
kernel; unit modulus and cell closure alone do not supply it.
-/

namespace InverseWarpTransferAudit
...
end InverseWarpTransferAudit

#print axioms InverseWarpTransferAudit.alternatingWarp_norm
#print axioms InverseWarpTransferAudit.warped_primitive_bounded
#print axioms InverseWarpTransferAudit.unwarped_half_not_summable

import RequestProject.DVPLadder399o2
import RequestProject.DVPExhaustion435o2
import RequestProject.DVPStation202
import RequestProject.DVPStation203
import RequestProject.DVPStation205
import RequestProject.DVPStation207
import RequestProject.DVPStation209
import RequestProject.DVPStation211
import RequestProject.DVPStation212
import RequestProject.DVPStation214
import RequestProject.DVPStation215
import RequestProject.DVPStation217

/-!
# Rung-217.5: on-line to 435/2, channel to 217
-/
...
/-- The ninety station heights. -/
def ladder435o2T (i : Fin 90) : ℝ :=
  if i.val = 0 then 11
...
/-- **The 90-station ladder is inhabited.** -/
theorem ladder435o2Data_holds : LadderData435o2 := by
  refine ⟨ladder435o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder435o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder435o2T]
  · intro i
    fin_cases i
    · norm_num [ladder435o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 435/2` is on the line.** -/
theorem online_below_435o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 435/2 → ρ.re = 1/2 :=
  online_below_435o2_of_ladder ladder435o2Data_holds

/-- **The channel to height 217, unconditional.** -/
theorem seat_channel_to_217 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 435/2) online_below_435o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder435o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_435o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_217
end AxiomAudit

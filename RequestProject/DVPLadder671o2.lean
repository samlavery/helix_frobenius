import RequestProject.DVPLadder618o2
import RequestProject.DVPExhaustion671o2
import RequestProject.DVPStation1242o4
import RequestProject.DVPStation312
import RequestProject.DVPStation313
import RequestProject.DVPStation315
import RequestProject.DVPStation317
import RequestProject.DVPStation318
import RequestProject.DVPStation320
import RequestProject.DVPStation643o2
import RequestProject.DVPStation323
import RequestProject.DVPStation324
import RequestProject.DVPStation326
import RequestProject.DVPStation328
import RequestProject.DVPStation659o2
import RequestProject.DVPStation331
import RequestProject.DVPStation333
import RequestProject.DVPStation334
import RequestProject.DVPStation335

/-!
# Rung-335.5: on-line to 671/2, channel to 335
-/
...
/-- The one hundred sixty-one station heights. -/
def ladder671o2T (i : Fin 161) : ℝ :=
  if i.val = 0 then 11
...
/-- **The 161-station ladder is inhabited.** -/
theorem ladder671o2Data_holds : LadderData671o2 := by
  refine ⟨ladder671o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder671o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder671o2T]
  · intro i
    fin_cases i
    · norm_num [ladder671o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 671/2` is on the line.** -/
theorem online_below_671o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 671/2 → ρ.re = 1/2 :=
  online_below_671o2_of_ladder ladder671o2Data_holds

/-- **The channel to height 335, unconditional.** -/
theorem seat_channel_to_335 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 671/2) online_below_671o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder671o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_671o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_335
end AxiomAudit

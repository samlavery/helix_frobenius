import RequestProject.DVPLadder561o2
import RequestProject.DVPExhaustion581o2
import RequestProject.DVPStation283
import RequestProject.DVPStation284
import RequestProject.DVPStation286
import RequestProject.DVPStation287
import RequestProject.DVPStation289
import RequestProject.DVPStation290

/-!
# Rung-290.5: on-line to 581/2, channel to 290
-/
...
/-- The one hundred thirty-three station heights. -/
def ladder581o2T (i : Fin 133) : ℝ :=
  if i.val = 0 then 11
...
/-- **The 133-station ladder is inhabited.** -/
theorem ladder581o2Data_holds : LadderData581o2 := by
  refine ⟨ladder581o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder581o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder581o2T]
  · intro i
    fin_cases i
    · norm_num [ladder581o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 581/2` is on the line.** -/
theorem online_below_581o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 581/2 → ρ.re = 1/2 :=
  online_below_581o2_of_ladder ladder581o2Data_holds

/-- **The channel to height 290, unconditional.** -/
theorem seat_channel_to_290 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 581/2) online_below_581o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder581o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_581o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_290
end AxiomAudit

import RequestProject.DVPLadder743o2
import RequestProject.DVPExhaustion780o2
import RequestProject.DVPStation747o2
import RequestProject.DVPStation375
import RequestProject.DVPStation376
import RequestProject.DVPStation378
import RequestProject.DVPStation379
import RequestProject.DVPStation381
import RequestProject.DVPStation382
import RequestProject.DVPStation384
import RequestProject.DVPStation771o2
import RequestProject.DVPStation387
import RequestProject.DVPStation388
import RequestProject.DVPStation389

/-!
# Rung-390: on-line to 780/2, channel to 389.5
-/
...
/-- The one hundred ninety-six station heights. -/
def ladder780o2T (i : Fin 196) : ℝ :=
  if i.val = 0 then 11
...
/-- **The 196-station ladder is inhabited.** -/
theorem ladder780o2Data_holds : LadderData780o2 := by
  refine ⟨ladder780o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder780o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder780o2T]
  · intro i
    fin_cases i
    · norm_num [ladder780o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 780/2` is on the line.** -/
theorem online_below_780o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 780/2 → ρ.re = 1/2 :=
  online_below_780o2_of_ladder ladder780o2Data_holds

/-- **The channel to height 389.5, unconditional.** -/
theorem seat_channel_to_389_5 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 780/2) online_below_780o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder780o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_780o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_389_5
end AxiomAudit

import RequestProject.DVPLadder91
import RequestProject.DVPExhaustion109
import RequestProject.DVPStation93
import RequestProject.DVPStation95
import RequestProject.DVPStation97
import RequestProject.DVPStation100
import RequestProject.DVPStation102
import RequestProject.DVPStation105
import RequestProject.DVPStation106
import RequestProject.DVPStation108

/-!
# Rung-109: on-line to 109, channel to 108.5
-/
...
/-- The thirty-four station heights. -/
def ladder109T (i : Fin 34) : ℝ :=
  if i.val = 0 then 11
...
/-- **The 34-station ladder is inhabited.** -/
theorem ladder109Data_holds : LadderData109 := by
  refine ⟨ladder109T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder109T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder109T]
  · intro i
    fin_cases i
    · norm_num [ladder109T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 109` is on the line.** -/
theorem online_below_109 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 109 → ρ.re = 1/2 :=
  online_below_109_of_ladder ladder109Data_holds

/-- **The channel to height 108.5, unconditional.** -/
theorem seat_channel_to_108_5 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 109) online_below_109 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder109Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_109
#print axioms CriticalLinePhasor.DVP.seat_channel_to_108_5
end AxiomAudit

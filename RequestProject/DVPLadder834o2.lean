import RequestProject.DVPLadder813o2
import RequestProject.DVPExhaustion834o2
import RequestProject.DVPStation408
import RequestProject.DVPStation410
import RequestProject.DVPStation411
import RequestProject.DVPStation413
import RequestProject.DVPStation414
import RequestProject.DVPStation1661o4
import RequestProject.DVPStation416

/-!
# Rung-417: on-line to 834/2, channel to 416.5
-/
...
/-- **The 214-station ladder is inhabited.** -/
theorem ladder834o2Data_holds : LadderData834o2 := by
  refine ⟨ladder834o2T, ?_, ?_, ?_⟩
  · rw [Fin.strictMono_iff_lt_succ]
    intro i
    fin_cases i <;> norm_num [ladder834o2T]
  · intro i
    fin_cases i <;> constructor <;> norm_num [ladder834o2T]
  · intro i
    fin_cases i
    · norm_num [ladder834o2T]
...
/-- **Every nontrivial zero of ordinate `|γ| ≤ 834/2` is on the line.** -/
theorem online_below_834o2 :
    ∀ ρ ∈ ZD.NontrivialZeros, |ρ.im| ≤ 834/2 → ρ.re = 1/2 :=
  online_below_834o2_of_ladder ladder834o2Data_holds

/-- **The channel to height 416.5, unconditional.** -/
theorem seat_channel_to_416_5 {w : ℂ}
  ...
  seat_channel_of_online_range (T := 834/2) online_below_834o2 hw hw' him
    (by linarith)

end CriticalLinePhasor.DVP

section AxiomAudit
#print axioms CriticalLinePhasor.DVP.ladder834o2Data_holds
#print axioms CriticalLinePhasor.DVP.online_below_834o2
#print axioms CriticalLinePhasor.DVP.seat_channel_to_416_5
end AxiomAudit

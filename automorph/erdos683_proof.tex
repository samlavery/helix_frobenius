...
Theorem~\ref{thm:reduction} settles $99.38\%$ of \emph{that} range unconditionally.  The
figure is range-dependent and must be quoted with its range: the disposed fraction rises to
$99.707\%$ over $2001\le n\le6000$ and $99.896\%$ over $6001\le n\le20000$, so the residual
is shrinking and no single percentage characterises the reduction.

...
and nonzero: \emph{the Ceresa cycle of this curve is non-trivial,
unconditionally} (\texttt{hv\_exact\_new.py}). Register: the detection is
numerical (a base-point-invariant nonzero value, not an interval certificate),
...
constraint. Step~three should then \emph{fall out}
...
parametrization --- the rung's next named computation, with the
identification of the component as a translate of $W_3$ the named open
question beside it.

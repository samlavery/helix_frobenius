...
\noindent The level-$N$ statement --- finitely many twisted functional equations
sufficing for $\Gamma_0(N)$-automorphy --- is Weil's lemma, consumed at the cited
converse-theorem layer of \S\ref{sec:cps-thm} exactly as before.

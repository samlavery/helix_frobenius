...
(\texttt{maass\_converse\_of\_BV}) and the remaining identification is the
real-analytic wave-form step (the Hecke--Maass analogue of the q-expansion argument;
the holomorphic identity theorem does not apply, so it is a named extension, its
reflection input already compiled); at higher rank the identification is the cited
...
Theorem~\ref{thm:hecke-modularity}), and the $\Sym^r$ exchange interface

...
$n$-dependent removal kernel has summable variation.  Placing both ordinary completed readouts on an open strip
therefore requires the raw primitive hypothesis of Lemma~\ref{lem:transfer} or the kernel hypotheses of
\texttt{WarpRemovalTransfer.warpRemoval\_transfer\_tendsto}; machine-checked end-to-end for the character classes
...
\texttt{WarpRemovalTransfer.warpRemoval\_transfer\_tendsto} after proving its summable inverse-kernel

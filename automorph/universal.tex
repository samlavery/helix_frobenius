...
chain: the cancellation input equidistributes the angles against the absolutely
continuous carrier measure — a shape a four-point pinning cannot attain; the
compiled completion of that incompatibility (nondegeneracy of the four-point
Chebyshev moment matrix, closing ``fully frozen $\Rightarrow$ cancellation
fails'') is the named next brick.  The fork is Sato--Tate's own
non-Galois-type hypothesis, typed at the seed: rational data freeze, generic data
drift.

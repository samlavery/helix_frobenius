...
of level-one modularity.  Packaging the resulting multiplier system as a typed
slash-invariant form (the weight/multiplier bookkeeping along the closure induction)
is a named extension; the level-$N$ statement --- finitely many twisted functional
...
\texttt{ChainKernelContinuity}), the Hecke identification
(\texttt{WeilIdentification}), and the $\Sym^r$ exchange interface

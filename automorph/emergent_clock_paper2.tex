...
% CANONICAL HOME: automorph/universal.tex \S cps-satotate (headlined in its
% contributions; Lean-wired via strand_radius_one_of_tower_ceiling).  This scratch
% copy is retained verbatim below for working reference only — edit the universal
% copy, never this one.  (Collapsed to pointer 2026-07-31.)

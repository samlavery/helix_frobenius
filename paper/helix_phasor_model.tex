...
$r_n$; the winding contributes unit modulus (Theorem~\ref{thm:windmul}).
\end{remark}
...
\code{Faithfulness.lean}, \code{AreaLaw.lean}). Each named
...
(Theorem~\ref{thm:arealaw}, Definition~\ref{def:wound}) in \code{AreaLaw.lean}.

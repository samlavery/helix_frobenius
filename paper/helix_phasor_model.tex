...
phasors. The growing radius $\sqrt n$ is itself emergent from the arclength geometry (the area law),
and the critical exponent $\tfrac12$ on which the zeros are found is not assumed but \emph{derived}
from it --- the unique $\sigma$ at which the phasor amplitude $n^{-\sigma}$ balances that radius. The
